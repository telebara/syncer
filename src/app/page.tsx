...
import { generateRoomCode, getMockVideos, UserVideoDTO } from "../utils";
import Avatar from "./components/Avatar";
import Library from "./components/Library";


const HomePage = () => {
  const { user, signOutUser, updateUserProfile } = useFirebaseAuth();
...
const Page = () => {
  ...
  if (loading) {
    return <div className={styles.page}><main className={styles.main}>Загрузка...</main></div>;
  }
